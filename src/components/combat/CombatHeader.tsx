    ...
    return (
      <header className="flex items-center justify-between px-6 py-4 border-b border-border">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-teal-400 font-bold text-lg tracking-wide">ASTERIA</span>
        </div>

        <div className="flex flex-col items-center">
          <span className="text-xs text-text-muted uppercase tracking-widest mb-1">Phase</span>
          <div className="text-text-primary font-bold text-xl">Shop</div>
        </div>

        <div className="flex items-center gap-6">
          <div className="flex flex-col items-end">
            <span className="text-xs text-text-muted uppercase tracking-widest">Encounter</span>
